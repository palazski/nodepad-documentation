...
<CardGroup cols={2}>
  <Card title="Upgrade & rollback playbook" icon="arrow-up" href="/enterprise/operations/upgrade">
    How to upgrade safely, roll back, and handle migration-incompatible rollbacks.
  </Card>
  <Card title="Air-gapped install details" icon="shield-halved" href="/enterprise/operations/air-gapped">
