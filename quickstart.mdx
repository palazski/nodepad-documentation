...
<Columns cols={3}>
  ...
  <Card title="Per-message model selection" icon="sparkles" href="/models/per-message-selection">
    Switch models message by message instead of locking a workspace to one.
  </Card>
</Columns>
